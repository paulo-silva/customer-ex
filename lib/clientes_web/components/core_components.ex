defmodule ClientesWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(ClientesWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(ClientesWeb.Gettext, "errors", msg, opts)
    end
  end
